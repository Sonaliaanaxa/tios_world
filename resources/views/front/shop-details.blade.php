...
<main>
                    ...
                    <div class="shop-details-flex-wrap">
                        <div class="shop-details-nav-wrap">
                            <ul class="nav nav-tabs" id="myTab" role="tablist">
                                ...
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link" id="item-two-tab" data-toggle="tab" href="#item-two" role="tab" aria-controls="item-two" aria-selected="false"><img src="{{asset('assets/front/img/product/sd_nav_img02.jpg')}}" alt=""></a>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link" id="item-three-tab" data-toggle="tab" href="#item-three" role="tab" aria-controls="item-three" aria-selected="false"><img src="{{asset('assets/front/img/product/sd_nav_img03.jpg')}}" alt=""></a>
                                </li>
                            </ul>
                        </div>
                            ...
                            <div class="tab-content" id="myTabContent">
                                <div class="tab-pane fade show active" id="item-one" role="tabpanel" aria-labelledby="item-one-tab">
                                    <div class="shop-details-img">
                                        <img src="{{asset('assets/front/img/product/shop_details_img01.jpg')}}" alt="">
                                    </div>
                                </div>
                                <div class="tab-pane fade" id="item-two" role="tabpanel" aria-labelledby="item-two-tab">
                                    <div class="shop-details-img">
                                        <img src="{{asset('assets/front/img/product/shop_details_img02.jpg')}}" alt="">
                                    </div>
                                </div>
                                <div class="tab-pane fade" id="item-three" role="tabpanel" aria-labelledby="item-three-tab">
                                    <div class="shop-details-img">
                                        <img src="{{asset('assets/front/img/product/shop_details_img03.jpg')}}" alt="">
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-lg-5">
                    <div class="shop-details-content">
                        ...
                        <div class="shop-details-meta">
                            <ul>
                                <li>Baands : <a href="{{route('contact')}}">Thehygieneherbs</a></li>
                        ...
                        <div class="shop-details-list">
                            <ul>
                                ...
                                <li>CO : <span>Thehygieneherbs</span></li>
                            </ul>
                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-xl-3 col-md-5">
                                            <div class="product-desc-img">
                                                <img src="{{asset('assets/front/img/product/desc_img.jpg')}}" alt="">
                                            </div>
                                        </div>
    ...
    <!-- best-sellers-area -->
    <section class="best-sellers-area  pb-70">
        <div class="container">
            <div class="row align-items-end mb-40">
                ...
                <div class="col-md-4 col-sm-3">
                    <div class="section-btn text-left text-md-right">
                        <a href="{{route('home')}}" class="btn">View All</a>
                    </div>
                </div>
            </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-3">
                        <div class="sp-product-item mb-20">
                            <div class="sp-product-thumb">
                                ...
                                <a href="{{route('shop-details')}}"><img src="{{asset('assets/front/img/product/sp_products09.png')}}" alt=""></a>
                            </div>
                            <div class="sp-product-content">
                                ...
                                <h6 class="title"><a href="{{route('shop-details')}}">Uncle Orange Vanla Ready Pice</a></h6>
                    ...
                    <div class="col-3">
                        <div class="sp-product-item mb-20">
                            <div class="sp-product-thumb">
                                ...
                                <a href="{{route('shop-details')}}"><img src="{{asset('assets/front/img/product/sp_products02.png')}}" alt=""></a>
                            </div>
                            <div class="sp-product-content">
                                <div class="rating">
                                    <i class="fas fa-star"></i>
                                ...
                                <h6 class="title"><a href="{{route('shop-details')}}">Dannon Max Vanla ice cream</a></h6>
                                <span class="product-status">IN Stock</span>
                                <div class="sp-cart-wrap">
                                    <form action="#">
                                        <div class="cart-plus-minus">
                    ...
                    <div class="col-3">
                        <div class="sp-product-item mb-20">
                            <div class="sp-product-thumb">
                                ...
                                <a href="{{route('shop-details')}}"><img src="{{asset('assets/front/img/product/sp_products03.png')}}" alt=""></a>
                            </div>
                            <div class="sp-product-content">
                                <div class="rating">
                                    <i class="fas fa-star"></i>
                                ...
                                <h6 class="title"><a href="{{route('shop-details')}}">Walnuts Max Vanla Greek Pice</a></h6>
                                <span class="product-status">IN Stock</span>
                                <div class="sp-cart-wrap">
                                    <form action="#">
                                        <div class="cart-plus-minus">
                    ...
                    <div class="col-3">
                        <div class="sp-product-item mb-20">
                            <div class="sp-product-thumb">
                                <span class="batch">new</span>
                                <a href="{{route('shop-details')}}"><img src="{{asset('assets/front/img/product/sp_products04.png')}}" alt=""></a>
                            </div>
                            <div class="sp-product-content">
                                <div class="rating">
                                    <i class="fas fa-star"></i>
                                ...
                                <h6 class="title"><a href="{{route('shop-details')}}">Brachs Bens Vanla Ready Pice</a></h6>
                                <span class="product-status">IN Stock</span>
                                <div class="sp-cart-wrap">
                                    <form action="#">
                                        <div class="cart-plus-minus">
                    ...
                    <div class="col-3">
                        <div class="sp-product-item mb-20">
                            <div class="sp-product-thumb">
                                <span class="batch discount">25%</span>
                                <a href="{{route('shop-details')}}"><img src="{{asset('assets/front/img/product/sp_products05.png')}}" alt=""></a>
                            </div>
                            <div class="sp-product-content">
                                <div class="rating">
                                    <i class="fas fa-star"></i>
                                ...
                                <h6 class="title"><a href="{{route('shop-details')}}">Black Lady Vanla Greek Grapes</a></h6>
                                <span class="product-status">IN Stock</span>
                                <div class="sp-cart-wrap">
                                    <form action="#">
                                        <div class="cart-plus-minus">
