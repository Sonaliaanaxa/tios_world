                                ...
                                <tbody id="myTable">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @if($r->upload_image)
                                            <a href="{{ asset('/uploads/trial_products') }}/{{ $r->upload_image }}" target='_blank'> <img src="{{ asset('/uploads/trial_products') }}/{{ $r->upload_image }}" style='height:50px;width:50px;border-radius:5%;' /></a>
                                            @else
