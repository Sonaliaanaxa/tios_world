				...
				<div class="card">
								...
								<div class="row">
									...
									<div class="col-sm-6 col-md-4">
										<div class="form-group{{ $errors->has('subcategory_id') ? ' has-danger' : '' }}">
											<select class="custom-select {{ $errors->has('subcategory_id') ? ' is-invalid' : '' }}subcategory" name='subcategory_id' id="subcategoryList">
												<option selected disabled>Select Sub Category</option>
												@foreach($subcategories as $c)
												<option value='{{ $c->id}}' {{ ($c->id==$product->subcategory_id)?'selected':''}}> {{ $c->name}} </option>
												@endforeach
											</select>
							...
							<div class="row">
								...
								<div class="col-sm-4">
									<div class="form-group{{ $errors->has('quantity') ? ' has-danger' : '' }}">
										<input class="form-control{{ $errors->has('quantity') ? ' is-invalid' : '' }}" id="input-quantity" type="number" placeholder="{{ __(' Quantity ') }}" value="{{  $product->quantity }}" name="quantity" aria-required="true" />
					...
					<div class="row" id="file-content">
						...
						<div class="col-sm-10">
							...
							<br>
							<img src="{{ asset('/uploads/trial_products') }}/{{ $product->upload_image }}" style='margin-bottom:30px;height:200px;width:250px;border-radius:5%;' />
							<br>
