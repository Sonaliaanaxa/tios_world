					...
					<div class="row">
						<div class="col-sm-12">
							<div class="card">
								...
								<!-- Add Blog -->
                <form method='post'  action="{{ route('business.partners.create') }}"  enctype="multipart/form-data">
          @csrf
									...
									<div class="service-fields mb-3">
										...
										<div class="form-group col-md-6">
                                                ...
                                                <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                                                    <input class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" name="name" id="input-name" type="text" placeholder="{{ __('BusinessPartner Name') }}"  value="{{ old('name') }}"  aria-required="true"/>
                                                    @if ($errors->has('name'))
										...
										<div class="form-group col-md-6">
                                                ...
                                                <div class="form-group{{ $errors->has('link') ? ' has-danger' : '' }}">
                                                    <input class="form-control{{ $errors->has('link') ? ' is-invalid' : '' }}" name="link" id="input-link" type="text" placeholder="{{ __('Link') }}"  value="{{ old('link') }}"  aria-required="true"/>
                                                    @if ($errors->has('link'))
