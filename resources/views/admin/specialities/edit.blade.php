									...
									<div class="service-fields mb-3">
										...
										<div class="form-group col-md-6">
                                                ...
                                                <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                                                    <input class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" name="name" id="input-name" type="text" placeholder="{{ __('Name') }}"  value="{{$specialities->name}}"  aria-required="true"/>
                                                    @if ($errors->has('name'))
										   ...
										   <div class="upload-img">
												   <div class="change-photo-btn">
													 ...
													 id="myImage"
													   /></label>
													   <br>
												 <img src="{{ asset('public/uploads/specialities') }}/{{ $specialities->img }}" style='margin-bottom:30px;height:200px;width:250px;border-radius:5%;'/>
													   <br>
												   </div>
