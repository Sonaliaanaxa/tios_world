                      ...
                      <?php $i++; ?>
                        ...
                        <?php echo $i; ?>
                          ...
                          <td>
                               ...
                               @if($r->img)
                                 <a href="{{ asset('public/uploads/categories') }}/{{ $r->img }}" target='_blank'> <img src="{{ asset('public/uploads/categories') }}/{{ $r->img }}" style='height:50px;width:50px;border-radius:5%;'/></a>
                                @else
