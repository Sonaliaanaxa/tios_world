								...
								<div class="row">
									...
									<div class="form-group col-md-6">
										...
										<div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
											<input class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" name="name" id="input-name" type="text" placeholder="{{ __('Category Name') }}" value="{{ old('name') }}" aria-required="true" />
											@if ($errors->has('name'))
									...
									<div class="form-group col-md-6">
										...
										<div class="form-group{{ $errors->has('slug') ? ' has-danger' : '' }}">
											<input class="form-control{{ $errors->has('slug') ? ' is-invalid' : '' }}" name="slug" id="input-slug" type="text" placeholder="{{ __('Category Slug') }}" value="{{ old('slug') }}" aria-required="true" />
											@if ($errors->has('slug'))
