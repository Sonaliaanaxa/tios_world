        ...
        <div class="page-header">
            <div class="row">
                ...
                <div class="col-sm-5 col">
                    <a href="{{route('units.create')}}" class="btn btn-primary float-right mt-2"><i class='fa fa-plus-circle'> {{ __('New') }}</i></a>
                </div>
            </div>
        </div>
                                ...
                                <tbody id="myTable">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{route('units.update',$r->id)}}" style='color:#0099cc;font-size:16px;padding-right:15px;' title="Update" data-id="{{$r->id}}">
            ...
            $.ajax({
                ...
                success: function(data) {
                    if (data.success == 1) {
                        ...
                        swal("Success!", "Unit Successfully Deleted!", "success");
