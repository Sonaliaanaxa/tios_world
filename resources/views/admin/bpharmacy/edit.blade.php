...
<div class="page-wrapper">
					...
					<div class="row">
						<div class="col-sm-12">
							<div class="card">
                                ...
                                <form method='post'  action="{{ route('pharmacy.img.update',$user->id) }}"  enctype="multipart/form-data">
                              @csrf
                        ...
                        <div class="card">
                            <div class="card-body">
								...
								<!-- Add Blog -->
                                <form method='post'  action="{{ route('pharmacy.update',$user->id) }}"  enctype="multipart/form-data">
                                @csrf
		...
		<div class="card-body">
			<div class="payment-widget">
                ...
                <form method='post'  action="{{ route('pharmacy.acc.profile.update',$user->id) }}"  enctype="multipart/form-data">
					  @csrf
