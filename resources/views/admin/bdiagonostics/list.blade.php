                ...
                <div class="page-header">
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <a href="{{route('diagonostics.create')}}"  class="btn btn-primary float-right mt-2"><i class='fa fa-plus-circle'> {{ __('New') }}</i></a>
                            </h3>
                         
                            <ul class="breadcrumb">
                                <li class="breadcrumb-item">Total Diagnostics -  {{ $dCount}}</li>
                    ...
                    <div class="col-sm-12">
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    ...
                                    <thead class=" text-default" style='color:whitesmoke;'>
                                            ...
                                            <th>
                                            @sortablelink('name',__('diagonostic'))  
                                            </th>
                                            <th>
                                            ...
                                            <th>
                                            @sortablelink('specialization',__('Speciality'))  
                                            </th>
                     ...
                     @sortablelink('action',__('Action'))  
                                            ...
                                            <?php echo $i; ?>
                                                ...
                                                <td>
                                                    ...
                                                    @if($r->img)
                                                        ...
                                                        @endif
                                                        <a href="{{route('diagonostics.view',$r->id)}}">{{ $r->name }}</a>
                                                    </h2>
                                                </td>
                                                </td>
                       		...
                       		<?php
                                                        ...
                                                        $arr=json_decode($r->specialization,true);
                         ...
                         <i class="fa fa-key"></i></a>
                          ...
                          <a href="{{route('diagonostics.view',$r->id)}}"  target='_blank' style='color:#0099cc;font-size:16px;padding-right:15px;' title="Update" data-id="{{$r->id}}">
                         <i class="fa fa-eye"></i></a>
<br>
                           <a href="{{route('diagonostics.update',$r->id)}}" style='color:#0099cc;font-size:16px;padding-right:15px;' title="Update" data-id="{{$r->id}}">
                         <i class="fa fa-edit"></i></a>

                         <a href="javascript:;" style='color:#0099cc;font-size:16px;padding-right:15px;' class='delete-diagonostic' title="Delete" data-id="{{$r->id}}">
                        ...
                        {!! $diagonostics->appends(request()->except('page'))->render() !!}
                    </div>
                </div>
  ...
  <script>
        $(document).ready(function() {
            $('.delete-diagonostic').on('click', function (e) {
                ...
                $.ajax({
                    type: 'POST',
                    url:"{{route('diagonostics.destroy')}}",
                    data: {id: id, _token: '{{ csrf_token() }}'},
                    success: function (data) {
                        if (data.success == 1) {
                        //    selector.closest('tr').hide('slow');
                             swal("Success!", "Diagonostic Successfully Deleted!", "success");
