...
<div class="page-wrapper">
					...
					<div class="page-header">
						<div class="row">
							<div class="col-sm-12">
                                ...
                                <a href="{{route('diagonostics.list')}}"  class="btn btn-primary float-right" ><i class='fa fa-arrow-left'>  {{ __('Back') }}</i> </a>
                                </h3>
					...
					<div class="row">
						<div class="col-sm-12">
							<div class="card">
                                ...
                                <form method='post'  action="{{ route('diagonostics.img.update',$user->id) }}"  enctype="multipart/form-data">
                              @csrf
                        ...
                        <div class="card">
                            <div class="card-body">
								...
								<!-- Add Blog -->
                                <form method='post'  action="{{ route('diagonostics.update',$user->id) }}"  enctype="multipart/form-data">
                                @csrf
		...
		<div class="card-body">
			<div class="payment-widget">
                ...
                <form method='post'  action="{{ route('diagonostics.acc.profile.update',$user->id) }}"  enctype="multipart/form-data">
					  @csrf
  ...
  <div class="card">
        <div class="card-body">
            ...
            <form method='post'  action="{{ route('hospital.dig.info.profile.update',$user->id) }}"  enctype="multipart/form-data">
                @csrf
                ...
                <div class="col-md-12">
                        <div class="form-group">
                            <label>Price/Charge Detail</label>
                            <div class="form-group{{ $errors->has('price') ? ' has-danger' : '' }}">
                                <input class="form-control{{ $errors->has('price') ? ' is-invalid' : '' }}" name="price" id="input-price" type="text" placeholder="{{ __('Price/Charge') }}"  value="{{ $user->price}}"  aria-required="true"/>
                                @if ($errors->has('price'))
            ...
            <div class="card">
                            <div class="card-body">
                                ...
                                <form method='post'  action="{{ route('diagonostics.img.document.profile.update',$user->id) }}"  enctype="multipart/form-data">
                              @csrf
        ...
        <div class="card-body">
            ...
            <form method='post'  action="{{ route('diagonostics.education.profile.update',$user->id) }}"  enctype="multipart/form-data">
                @csrf
    ...
    <div class="card services-card">
        <div class="card-body">
            ...
            <form method='post'  action="{{ route('diagonostics.services.profile.update',$user->id) }}"  enctype="multipart/form-data">
                @csrf
