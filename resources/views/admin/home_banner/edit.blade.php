  ...
  <div class="content">
    <div class="container-fluid">
      <div class="row">
        ...
        <form method='post'  action="{{route('home.banner.update',$id)}}"  enctype="multipart/form-data">
          @csrf
            ...
            <div class="card ">
              ...
              <label class="col-sm-2 col-form-label">{{ __('Title') }}</label>
                ...
                <div class="row"  id="file-content" >
                          ...
                          /></label>
                          <br>
                          <img src="{{ asset('/uploads/banner') }}/{{ $homeslides->image }}" style='margin-bottom:30px;height:200px;width:450px;'/>
                                <br>
                             </div>
