                ...
                <div class="page-header">
                    <div class="row">
                        <div class="col-sm-7 col-auto">
                            ...
                            <ul class="breadcrumb">
                                <li class="breadcrumb-item">Total Home Notifications -  {{ $cCount}}</li>
              ...
              <div class="row">
                ...
                <div class="row">
                    <div class="col-sm-12">
                     ...
                     <tbody id="myTable"> 
                    <?php $i=0; ?>
                      @foreach($homenotifications as $r)
                      <?php $i++; ?>
                        <tr>
                        <td>
                        <?php echo $i; ?>
                     ...
                     <td>
                               ...
                               @if($r->img)
                                 <a href="{{ asset('public/uploads/homenotifications') }}/{{ $r->img }}" target='_blank'> <img src="{{ asset('public/uploads/homenotifications') }}/{{ $r->img }}" style='height:60px;width:80px;border-radius:5%;'/></a>
                                @else
                          ...
                          <td>
                           ...
                           <a href="{{route('home.notification.update',$r->id)}}" style='color:#0099cc;font-size:16px;padding-right:15px;' title="Update" data-id="{{$r->id}}">
                      ...
                      @endforeach
                        ...
                        {!! $homenotifications->appends(request()->except('page'))->render() !!}
                    </div>
                </div>
            </div>
        </div>
