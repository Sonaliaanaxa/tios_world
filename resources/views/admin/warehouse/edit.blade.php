			...
			<div class="col-sm-12">
				<div class="card">
					<div class="card-body custom-edit-service">
						...
						<!-- Add Blog -->
						<form method='post' action="{{ route('warehouse.update',$id) }}" enctype="multipart/form-data">
							@csrf
								...
								<div class="row">
									...
									<div class="col-sm-6 col-md-4">
										<div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
											<div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
												<input class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" name="name" id="input-name" type="text" placeholder="{{ __('Warehouse Name') }}" value="{{ $warehouse->name }}" aria-required="true" />
												@if ($errors->has('name'))
									...
									<div class="col-sm-6 col-md-4">
										<div class="form-group{{ $errors->has('contact_person_name') ? ' has-danger' : '' }}">
											<div class="form-group{{ $errors->has('contact_person_name') ? ' has-danger' : '' }}">
												<input class="form-control{{ $errors->has('contact_person_name') ? ' is-invalid' : '' }}" name="contact_person_name" id="input-contact_person_name" type="text" placeholder="{{ __('Contact Person Name') }}" value="{{ $warehouse->contact_person_name }}" aria-required="true" />
									...
									<div class="col-sm-6 col-md-4">
										<div class="form-group{{ $errors->has('contact_person_no') ? ' has-danger' : '' }}">
											<div class="form-group{{ $errors->has('contact_person_no') ? ' has-danger' : '' }}">
												<input class="form-control{{ $errors->has('contact_person_no') ? ' is-invalid' : '' }}" name="contact_person_no" id="input-contact_person_no" type="text" placeholder="{{ __('Contact Person Number') }}" value="{{ $warehouse->contact_person_no }}" aria-required="true" />
									...
									<div class="col-sm-6 col-md-4">
										<div class="form-group{{ $errors->has('address') ? ' has-danger' : '' }}">
											<div class="form-group{{ $errors->has('address') ? ' has-danger' : '' }}">
												<input class="form-control{{ $errors->has('address') ? ' is-invalid' : '' }}" name="address" id="input-address" type="text" placeholder="{{ __('Address') }}" value="{{ $warehouse->address }}" aria-required="true" />
									...
									<div class="col-sm-6 col-md-4">
										<div class="form-group{{ $errors->has('pincode') ? ' has-danger' : '' }}">
											<div class="form-group{{ $errors->has('pincode') ? ' has-danger' : '' }}">
												<input class="form-control{{ $errors->has('pincode') ? ' is-invalid' : '' }}" name="pincode" id="input-pincode" type="number" placeholder="{{ __('Pincode') }}" value="{{ $warehouse->pincode }}" aria-required="true" />
						...
						<div class="col-sm-4">
							<div class="form-group{{ $errors->has('status') ? ' has-danger' : '' }}">
								<select class="custom-select {{ $errors->has('status') ? ' is-invalid' : '' }}" name='status' id="input-status">
									<option value='{{ $warehouse->status }}'>Select Status</option>
									<option value='1' {{ ('1'==$warehouse->status)?'selected':''}}> Active </option>
									<option value='0' {{ ('0'==$warehouse->status)?'selected':''}}> Inactive</option>
