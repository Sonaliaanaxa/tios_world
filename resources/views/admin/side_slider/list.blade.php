        ...
        <div class="col-md-12">
            ...
            <div class="card-header card-header-default" >
                <h4 class="card-title" >{{ __($title) }}
                 <a href="{{route('side.slider.create')}}"  class="btn btn-primary float-right mt-2"><i class='fa fa-plus-circle'> {{ __('New') }}</i></a>
                    ...
                    <?php $i=0; ?>
                      ...
                      <?php $i++; ?>
                        ...
                        <?php echo $i; ?>
                          ...
                          <td>
                           <a href="{{route('side.slider.update',$r->id)}}" style='color:#0099cc;font-size:16px;padding-right:15px;' title="Update" data-id="{{$r->id}}">
