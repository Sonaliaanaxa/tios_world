                ...
                <div class="page-header">
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <a href="{{route('employee.create')}}"  class="btn btn-primary float-right mt-2"><i class='fa fa-plus-circle'> {{ __('New') }}</i></a>
                            </h3>
                         
                            <ul class="breadcrumb">
                                <li class="breadcrumb-item">Total Employee -  {{ $dCount}}</li>
                    ...
                    <div class="col-sm-12">
                     ...
                     @sortablelink('action',__('Action'))  
                                        ...
                                        <?php $i++; ?>
                                            ...
                                            <?php echo $i; ?>
                                                ...
                                                <td>
                                                    ...
                                                    @if($r->img)
                                                        <a href="{{ asset('public/uploads/profile_img') }}/{{ $r->img }}" ><img  src="{{ asset('public/uploads/profile_img') }}/{{ $r->img }}" alt="User Image" style="height:90px;width:90px;"></a>
                                                        @else
                         ...
                         <i class="fa fa-key"></i></a>
                           ...
                           <a href="{{route('employee.update',$r->id)}}" style='color:#0099cc;font-size:16px;padding-right:15px;' title="Update" data-id="{{$r->id}}">
