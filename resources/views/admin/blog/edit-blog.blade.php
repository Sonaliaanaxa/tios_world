					...
					<div class="row">
						<div class="col-sm-12">
							<div class="card">
								...
								<!-- Add Blog -->
                <form method='post'  action="{{ route('edit-blog',$id) }}"  enctype="multipart/form-data">
          @csrf
            @include('admin.layouts.flash_msg')
                  ...
                  <div class="col-sm-12 col-md-12">
                    ...
                    <div class="form-group{{ $errors->has('blog_title') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('blog_title') ? ' is-invalid' : '' }}" name="blog_title" id="input-blog_title" type="text" placeholder="{{ __(' Blog Title ') }}"  value="{{ $blogs->blog_title }}"  aria-required="true"/>
                  ...
                  <div class="col-md-12">
                    ...
                    <input class="form-control{{ $errors->has('short_details') ? ' is-invalid' : '' }}"  name="short_details" id="input-short_details" type="text" placeholder="{{ __(' Short Details') }}"   value="{{ $blogs->short_details }}"  aria-required="true"/>
                ...
                <div class="row"  id="file-content" >
                          ...
                          <br>
                          <img src="{{ asset('public/uploads/blog') }}/{{ $blogs->image }}" style='margin-bottom:30px;height:200px;width:250px;border-radius:5%;'/>
                                <br>
