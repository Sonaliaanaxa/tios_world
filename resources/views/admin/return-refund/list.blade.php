@include("admin.layouts.sidebar")
                ...
                <div class="page-header">
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <a href="{{route('return-refund.create')}}"  class="btn btn-primary float-right mt-2"><i class='fa fa-plus-circle'> {{ __('New') }}</i></a>
                            </h3>
                    ...
                    <div class="col-sm-12">
                        <div class="card">
                          ...
                          <td>
                           ...
                           <a href="{{route('return-refund.update',$r->id)}}" style='color:#0099cc;font-size:16px;padding-right:15px;' title="Update" data-id="{{$r->id}}">
                         <i class="fa fa-edit"></i></a>
                   
                         <a href="javascript:;" style='color:#0099cc;font-size:16px;padding-right:15px;' class='delete-return-refund' title="Delete" data-id="{{$r->id}}">
  ...
  <script>
        $(document).ready(function() {
            $('.delete-return-refund').on('click', function (e) {
                ...
                $.ajax({
                    type: 'POST',
                    url:"{{route('return-refund.destroy')}}",
