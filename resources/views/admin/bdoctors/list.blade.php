                ...
                <div class="page-header">
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <a href="{{route('doctors.create')}}"  class="btn btn-primary float-right mt-2"><i class='fa fa-plus-circle'> {{ __('New') }}</i></a>
                            </h3>
                         
                            <ul class="breadcrumb">
                                <li class="breadcrumb-item">Total Doctors -  {{ $dCount}}</li>
                    ...
                    <div class="col-sm-12">
                     ...
                     @sortablelink('action',__('Action'))  
                                            ...
                                            <?php echo $i; ?>
                                                ...
                                                <td>
                                                    ...
                                                    @if($r->img)
                                                        ...
                                                        @endif
                                                        <a href="{{route('doctors.view',$r->id)}}">{{ $r->name }}</a>
                                                    </h2>
                                                </td>
                                                </td>
                         ...
                         <i class="fa fa-key"></i></a>
                          ...
                          <a href="{{route('doctors.view',$r->id)}}"  target='_blank' style='color:#0099cc;font-size:16px;padding-right:15px;' title="Update" data-id="{{$r->id}}">
                         <i class="fa fa-eye"></i></a>
                     <br>
                           <a href="{{route('doctors.update',$r->id)}}" style='color:#0099cc;font-size:16px;padding-right:15px;' title="Update" data-id="{{$r->id}}">
                         <i class="fa fa-edit"></i></a>
                   
                         <a href="javascript:;" style='color:#0099cc;font-size:16px;padding-right:15px;' class='delete-doctor' title="Delete" data-id="{{$r->id}}">
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        //    selector.closest('tr').hide('slow');
                             swal("Success!", "Dector Successfully Deleted!", "success");
