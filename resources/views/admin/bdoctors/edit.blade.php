...
<div class="page-wrapper">
					...
					<div class="row">
						<div class="col-sm-12">
							<div class="card">
                                ...
                                <form method='post'  action="{{ route('doctors.img.update',$user->id) }}"  enctype="multipart/form-data">
                              @csrf
                      ...
                      @endif
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <form method='post'  action="{{ route('doctors.general.profile.update',$user->id) }}"  enctype="multipart/form-data">
                              @csrf
		...
		<div class="card-body">
			<div class="payment-widget">
                ...
                <form method='post'  action="{{ route('doctors.acc.profile.update',$user->id) }}"  enctype="multipart/form-data">
					  @csrf
  ...
  <div class="card">
        <div class="card-body">
            ...
            <form method='post'  action="{{ route('hospital.doc.info.profile.update',$user->id) }}"  enctype="multipart/form-data">
                @csrf
            ...
            <div class="card">
                            <div class="card-body">
                                ...
                                <form method='post'  action="{{ route('doctors.img.document.profile.update',$user->id) }}"  enctype="multipart/form-data">
                              @csrf
        ...
        <div class="card-body">
            ...
            <form method='post'  action="{{ route('doctors.education.profile.update',$user->id) }}"  enctype="multipart/form-data">
                @csrf
    ...
    <div class="card services-card">
        <div class="card-body">
            ...
            <form method='post'  action="{{ route('doctors.services.profile.update',$user->id) }}"  enctype="multipart/form-data">
                @csrf
...
foreach($arr as $key=>$value){
    ...
    echo  $value . ",";
                ...
                <div class="form-group mb-0">
                    ...
                    <small class="form-text text-muted">Note : Enter multiple specialization</small>
                </div>
                <br><br>
                    <!-- Experience -->
                    <div class="col-12">
