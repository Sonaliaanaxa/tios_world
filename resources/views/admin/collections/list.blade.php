        ...
        <div class="page-header">
            <div class="row">
                <div class="col-sm-7 col-auto">
                    ...
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item">Total Collections - {{ $cCount}}</li>

                    </ul>
                </div>
                <div class="col-sm-5 col">
                    <a href="{{route('collections.create')}}" class="btn btn-primary float-right mt-2"><i class='fa fa-plus-circle'> {{ __('New') }}</i></a>
                </div>
            </div>
        </div>
                            ...
                            <table class="datatable table table-hover table-center mb-0">
                                ...
                                <tbody id="myTable">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if($r->img)
                                            <a href="{{ asset('/uploads/collections') }}/{{ $r->img }}" target='_blank'> <img src="{{ asset('/uploads/collections') }}/{{ $r->img }}" style='height:50px;width:50px;border-radius:5%;' /></a>
                                            @else
                                        ...
                                        <td>
                                            ...
                                            <a href="{{route('collections.update',$r->id)}}" style='color:#0099cc;font-size:16px;padding-right:15px;' title="Update" data-id="{{$r->id}}">
