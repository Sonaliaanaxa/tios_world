...
<div class="page-wrapper">
					...
					<div class="page-header">
						<div class="row">
							<div class="col-sm-12">
                                ...
                                <a href="{{route('hospital.list')}}"  class="btn btn-primary float-right" ><i class='fa fa-arrow-left'>  {{ __('Back') }}</i> </a>
                                </h3>
					...
					<div class="row">
						<div class="col-sm-12">
							<div class="card">
                                ...
                                <form method='post'  action="{{ route('hospital.img.update',$user->id) }}"  enctype="multipart/form-data">
                              @csrf
                        ...
                        <div class="card">
                            <div class="card-body">
								...
								<!-- Add Blog -->
                                <form method='post'  action="{{ route('hospital.update',$user->id) }}"  enctype="multipart/form-data">
                                @csrf
		...
		<div class="card-body">
			<div class="payment-widget">
                ...
                <form method='post'  action="{{ route('hospital.acc.profile.update',$user->id) }}"  enctype="multipart/form-data">
					  @csrf
  ...
  <div class="card">
        <div class="card-body">
            ...
            <form method='post'  action="{{ route('hospital.hos.info.profile.update',$user->id) }}"  enctype="multipart/form-data">
                @csrf
            ...
            <div class="card">
                            <div class="card-body">
                                ...
                                <form method='post'  action="{{ route('hospital.img.document.profile.update',$user->id) }}"  enctype="multipart/form-data">
                              @csrf
    ...
    <div class="card services-card">
        <div class="card-body">
            ...
            <form method='post'  action="{{ route('hospital.services.profile.update',$user->id) }}"  enctype="multipart/form-data">
                @csrf
