  ...
  <div class="content">
    <div class="container-fluid">
      <div class="row">
        ...
        <form method='post'  action="{{route('navbar.update',$id)}}"  enctype="multipart/form-data">
          @csrf
              ...
              <label class="col-sm-2 col-form-label">{{ __('Name') }}</label>
                  ...
                  <div class="col-sm-12">
                    <div class="form-group{{ $errors->has('link') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('link') ? ' is-invalid' : '' }}" name="link" value="{{old('link')}}" id="input-link" type="text" placeholder="{{ $navbars->link }}"  aria-required="true"/>
                      @if ($errors->has('link'))
