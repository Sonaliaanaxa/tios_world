...
<head>
    ...
    <script src="{{ asset('public/material/home') }}/js/html5shiv.min.js"></script>
    <script src="{{ asset('public/material/home') }}/js/respond.min.js"></script>
                ...
                <li class="login-link">
                    ...
                    @if(isset(auth()->user()->name)!=null && isset(auth()->user()->name)!='')
                        <div class="btn-group" style="width: 100%;">
                            ...
                            <div class="dropdown-menu" x-placement="bottom-start" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(0px, 38px, 0px); width:100%;">
                                <a class="dropdown-item" href="{{ route('my.orders.his.list')}}"><i class="fa fa-shopping-cart" style='color:#155b96; '></i> Orders</a>
                                ...
                                <a class="dropdown-item" href="{{route('my.profile.view')}}"><i class="fa fa-user-circle" style='color:#155b96; '></i> Profile</a>
                                <a class="dropdown-item" href="{{route('my.profile.view')}}"> <i class="fa fa-key" style='color:#155b96; '></i> Change Password</a>
                                <a class="dropdown-item" href="{{route('userLogout')}}"><i class="fa fa-power-off" style='color:#155b96;'></i> Logout</a>
