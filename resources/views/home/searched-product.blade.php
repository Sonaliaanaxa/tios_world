...
<body>
    ...
    <!-- Main Wrapper -->
        ...
        @endif
                     ...
                     <img src="{{ asset('public/material/home') }}/img/cart.jpg" style='width:200px;height:200px;'>
                     <h3 align='center' style='padding:10px 100px;color:#0099cc;'> Sorry! No product found!</h3>
