                            ...
                            <div class="card-body">
                                    ...
                                    <div class="card schedule-widget mb-0">
                                      	...
                                      	@foreach($schedule as $sch)
											...
											<div class="col-md-2 col-sm-6" style='margin-top:4px;margin-bottom:4px;' >
	   <div class="container" style="padding:1px 1px;box-shadow: 1px 1px 1px 1px #dad4d4;border-radius:6px;max-width:600px;text-align:center;background-color:white;">
                                        <div class="row">
                                            <div class="col-md-11" style="margin:2px;">
