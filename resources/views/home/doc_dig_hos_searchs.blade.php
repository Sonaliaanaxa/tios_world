                        ...
                        <div class="card ">
                            ...
                            <div class="filter-widget">
                                    ...
                                    <div class="range-slider"><span class="range-box">from
                                      ...
                                      <!--  <input type="number"  value="{{ $datass[0] ?? '' }}" min="0" max="10000"/> to-->
                                      <!--  <input type="number" value="{{ $datass[1] ?? '' }}" min="0" max="10000"/></span>-->
                                      <!--<input value="{{ $datass[0] ?? '' }}"name="min" min="0" max="10000" step="500" type="range"/>-->
                                      <!--<input value="{{ $datass[1]?? '' }}" min="0" name="max" max="10000" step="500" type="range"/>-->
...
<input type="submit" value="Submit" name="submit"class="form-control" >
          ...
          <!--                              <a href="{{route('doctor')}}"><input type="checkbox" name="select_specialist" checked></a>-->
          ...
          <!--                          <div>-->
          <!--                          <label class="custom_check">-->
          <!--                              <a href="{{route('doctors','hospital')}}"><input type="checkbox" name="select_specialist" checked></a>-->
          ...
          <!--                          <div>-->
          <!--                          <label class="custom_check">-->
          <!--                              <a href="{{route('doctors','diagonostics')}}"><input type="checkbox" name="select_specialist" checked></a>-->
										<!--	<a href="{{route('doctors','diagonostics')}}"><span class="checkmark"></span> Diagonostic</a>-->
										<!--</label>-->
          <!--                          </div>-->
          <!--                          <br>-->
          <!--                          <div>-->
          <!--                              <label class="custom_check">-->
          <!--                              <a href="{{route('category')}}"><input type="checkbox" name="select_specialist" checked></a>-->
...
@endif
                     ...
                     <img src="{{ asset('public/material/home') }}/img/medicine-hospital.png" style='width:200px;height:200px;'>
                     <h3 align='center' style='padding:10px 100px;color:#0099cc;'> Sorry! No Search found!</h3>
