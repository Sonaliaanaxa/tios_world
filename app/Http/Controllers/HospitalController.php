...
class HospitalController extends Controller
{
    ...
    {
        $title = "All Hospital";
      $subtitle="allHospital";
      $activePage = "Hospitals";
      $user_type='hospital';
      $dCount=User::where('user_type',$user_type)->count();
      $hospital=User::where('user_type',$user_type)
         ->orderBy('id','DESC')
          ->sortable()->paginate(10);
  
        return view('admin.bhospitals.list',compact('title','hospital','activePage','subtitle','dCount'));
    }
    ...
    public function create()
    {
        ...
        $subtitle="Hospital";
        $activePage = "Hospital"; 
          return view('admin.bhospitals.add',compact('title','activePage','subtitle'));
    }
    ...
    public function save(Request $request)
    {
        ...
        return redirect(route('hospital.list'))->with('success', 'Hospital Successfully Added!');
    }
    ...
    public function edit(Request $request, $id)
    {
      ...
      $user=User::where('id',$id)->where('user_type',$user_type)->first();
        return view('admin.bhospitals.edit',compact('title','user','subtitle','activePage'));
    }
  ...
  $result=User::where('id',$id)->update($data);
      return redirect(route('hospital.list'))->with('success','Hospital Profile Successfully Updated!');
    }
  ...
  return redirect()->back()->with('success', 'Hospital/Clinic Information  Successfully Updated!');
    ...
    public function view(Request $request, $id)
    {
      ...
      $user=User::where('id',$id)->where('user_type',$user_type)->first();
        return view('admin.bhospitals.view',compact('title','user','subtitle','activePage'));
    }
    ...
    public function destroy(Request $request)
    {
      $id=$request->id; 
          ...
          if ($delete){
                ...
                return ['success' => 1, 'Hospital Successfully Deleted!'];
